...
//----------------------------------------------------------------------------//
// OTRs for LD versus OTR counts for non LD 
//----------------------------------------------------------------------------//
...
frame plot1 {
	...
	graph box otr_recipient_2 /*otr_recipient_3*/ otr_recipient_4, /// 
		...
		name(g1, replace) nooutsides note("") 
	graph box otr_recipient_2_perstudent otr_recipient_4, /// 
		...
		name(g3, replace) nooutsides note("")
	graph combine g1 g3, altshrink rows(1) ///
		title("Average Number of OTRs per Lesson by Recipient", size(medium))
}
